...
nohup $JAVA_HOME/bin/java -jar $MARKETPLACE_PATH/marketplace_Admin-0.0.1-SNAPSHOT.jar  > $MARKETPLACE_PATH/log/marketplace-adminLogs/nohup.out 2>&1 &
echo "Restarted marketPlace-admin"
